...
Welcome to `hello` contributor's guide.
...
If you experience bugs or general issues with `hello`, please have a look
...
You can help improve `hello` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`hello` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `hello`'s files. While this mechanism can
...
```
conda create -n hello python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/hello.git
   cd hello
   ```
...
5. Install [pre-commit]:
   ...
   `hello` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/hello
[issue tracker]: https://github.com/<USERNAME>/hello/issues
